    ...
    <Container className="container mt-3">
      ...
      <section>
        <form onSubmit={onHandleSubmit}>
          {/* age group */}
          <FormControl color="secondary" component="fieldset" className="form-control">
          ...
          {/* workPlan */}
          <FormControl color="secondary" component="fieldset" className="form-control">
            <FormLabel component="legend">Work plan for next 2 weeks</FormLabel>
            <RadioGroup
              aria-label="workPlan"
              name="workPlan"
              value={workPlan}
          ...
          {/* useOfMask */}
          <FormControl color="secondary" component="fieldset" className="form-control">
            <FormLabel component="legend">Wearing Mask out side home</FormLabel>
            <RadioGroup
